...
public class Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbcourse.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "HNDIT", "HNDA", "HNDE", "HNDTHM", "HNDM", "HNDBF" }));

        cmbsemister.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1st", "2nd", "3rd", "4th", " " }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/R.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(422, 582));
    ...
    private void btnregisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregisterActionPerformed
        try {
            String sql = "insert into student"
                    +"(student_id, name, f_name, course, branch, year,"
                    + " semister)values (?,?,?,?,?,?,?)";
